...
export default function EditShop() {
    ...
    const clickSubmit = () => {
        ...
        update({ shopId }, { t: jwt.token }, shopData)
            .then((data) => {
        ...
        read({ shopId }, signal).then((data) => {
            if (data.error) setValues({ ...values, error: data.error })
                ...
                setValues({
                    ...
                    description: data.description, owner: data.owner.name
                })
            }
        })
            ...
            <Grid item xs={6} sm={6}>
                <Card className={classes.card}>
                    <CardContent>
                        ...
                        <input accept="image/*" onChange={handleChange('image')} type="file"
                        ...
                        <label htmlFor="icon-button-file">
                            ...
                            {values.image ? values.image.name : ''}</span><br />
