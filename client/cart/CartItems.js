...
import {
    Card, CardContent, CardMedia, Button, makeStyles,
...
const useStyles = makeStyles(theme => ({
    ...
    cart: { width: '100%', display: 'inline-flex' },
    details: {
        display: 'inline-block',
    ...
    checkout: { float: 'right', margin: '24px' },
    total: {
        fontSize: '1.2em',
        color: 'rgb(53, 97, 85)',
        marginRight: '16px',
    ...
    continueBtn: { marginLeft: '10px' },
    itemShop: {
        display: 'block',
        fontSize: '0.90em',
        color: '#78948f'
    },
    removeButton: { fontSize: '0.8em' }
}))
                ...
                return <span key={i}><Card className={classes.cart}>
                    ...
                    <div className={classes.details}>
                        <CardContent className={classes.content}>
                            ...
                            <div>
                                <Typography type="subheading" component="h3"
                                    className={classes.price} color="primary">
                                    $ {item.product.price}
                                </Typography>
                        ...
                        <div className={classes.subheading}>
                            Quantity: <TextField value={item.quantity}
                                onChange={handleChange(i)} type="number"
                                inputProps={{ min: 1 }} margin="normal"
                                className={classes.textField}
                                InputLabelProps={{ shrink: true, }} />
                            <Button className={classes.removeButton}
                                color="primary" onClick={removeItem(i)}>
                                x Remove
                            </Button>
                        </div>
                    </div>
