...
import {
    makeStyles, Button, Card, CardMedia, IconButton,
    Icon, List, ListItem, ListItemSecondaryAction,
    Typography, Divider
...
export default function MyProducts(props) {
    ...
    useEffect(() => {
        ...
        listByShop({ shopId: props.shopId }, signal)
            .then((data) => {
                    ...
                    return <span key={i}>
                        <ListItem>
                            ...
                            <ListItemSecondaryAction>
                                ...
                                <DeleteProduct product={product} shopId={props.shopId}
